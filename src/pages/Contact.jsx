    ...
    <div className="page-enter">
      <div className="page-header">
        ...
        <div className="container page-header__content">
          <p className="page-header__tag">Nous contacter</p>
          <h1 className="page-header__title">Contactez-nous</h1>
          <p className="page-header__sub">[ وصف قسم التواصل ]</p>
        </div>
      </div>
      ...
      <section className="contact-section">
        <div className="container contact-inner">
          ...
          <div className="contact-info">
            <h2 className="contact-info__title">Informations de contact</h2>
            ...
            <div className="contact-cards">
              <div className="contact-card">
                ...
                <div>
                  ...
                  <span>[ العنوان الكامل ]<br />Tiaret, Algérie</span>
                </div>
              </div>
              <div className="contact-card">
                <div className="contact-card__icon">📞</div>
                <div>
                  ...
                  <a href="tel:+213XXXXXXXXX">[ رقم الهاتف ]</a>
                </div>
              </div>
              <div className="contact-card">
                ...
                <div>
                  <strong>Email</strong>
                  <a href="mailto:contact@avocat-tiaret.dz">[ البريد الإلكتروني ]</a>
                </div>
              </div>
              <div className="contact-card">
                <div className="contact-card__icon">🕐</div>
            ...
            <div className="map-container">
              <iframe
                title="Localisation Cabinet Avocat Tiaret"
          ...
          <div className="contact-form-wrap">
            ...
            {status === 'success' ? (
              <div className="form-success">
                ...
                <button className="btn-primary" onClick={() => setStatus(null)}>Envoyer un autre message</button>
              </div>
            ) : (
              <form className="contact-form" onSubmit={handleSubmit}>
                ...
                <div className="form-row">
                  <div className="form-group">
                    ...
                    <input type="tel" name="phone" value={form.phone} onChange={handleChange} placeholder="+213 XX XX XX XX" />
                  </div>
                  <div className="form-group">
                    <label>Sujet *</label>
                ...
                <div className="form-group">
                  <label>Message *</label>
                  <textarea name="message" value={form.message} onChange={handleChange} placeholder="Décrivez votre situation juridique..." rows={6} required />
                </div>
                <button type="submit" className="btn-primary form-submit" disabled={status === 'sending'}>
                  {status === 'sending' ? <><span className="spinner" /> Envoi en cours...</> : <>📨 Envoyer le message</>}
                </button>
              </form>
            )}
          </div>
      ...
      <style>{`
        ...
        .map-container { border-radius: 10px; overflow: hidden; border: 1px solid var(--gray-light); }
