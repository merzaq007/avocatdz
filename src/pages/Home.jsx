    ...
    <div className="page-enter">
      ...
      <section className="hero">
        ...
        <div className="container hero__content">
          ...
          <h1 className={`hero__title ${visible ? 'animate-fadeInUp delay-1' : ''}`}>
            {t.hero.title} <span className="hero__title-gold">{t.hero.titleGold}</span>
          </h1>
          ...
          <div className={`hero__actions ${visible ? 'animate-fadeInUp delay-4' : ''}`}>
            <button className="btn-primary" onClick={() => setPage('contact')}>{t.hero.cta}</button>
            <button className="btn-outline" onClick={() => setPage('services')}>{t.hero.services}</button>
          </div>
        </div>
      ...
      <section className="section services-section">
        <div className="container">
          <div className="section-header">
            <p className="section-tag">{t.servicesSection.tag}</p>
      ...
      <section className="section why-section">
        <div className="container why-inner">
          <div className="why-text">
            ...
            <h2 className="section-title" style={{ whiteSpace: 'pre-line' }}>{t.why.title}</h2>
            <div className="gold-line" />
            ...
            <button className="btn-primary" onClick={() => setPage('about')}>{t.why.btn}</button>
          </div>
          <div className="why-visual">
            ...
            <div className="why-card-float why-card-float--1">{t.why.float1}</div>
            <div className="why-card-float why-card-float--2">{t.why.float2}</div>
          </div>
        </div>
      </section>
      ...
      <section className="section testimonials-section">
        <div className="container">
          ...
          <div className="testimonials-grid">
            {t.testimonials_data.map((item, i) => (
              <div key={i} className="testimonial-card">
                <div className="testimonial-card__stars">{'★'.repeat(item.stars)}</div>
      ...
      <section className="cta-banner">
        <div className="container cta-banner__inner">
          ...
          <div className="cta-banner__actions">
            <button className="btn-primary" onClick={() => setPage('contact')}>{t.cta.btn}</button>
            <a href="https://wa.me/213XXXXXXXXX" className="btn-outline" target="_blank" rel="noreferrer">{t.cta.whatsapp}</a>
          </div>
        </div>
      </section>
      ...
      <style>{`
        ...
        .hero__badge {
          ...
          font-size: 0.82rem; letter-spacing: 0.5px; margin-bottom: 28px; opacity: 0;
        }
        .hero__title {
          font-size: clamp(2.8rem,6vw,5rem); color: var(--white);
          line-height: 1.1; margin-bottom: 16px; opacity: 0;
        }
        .hero__title-gold { color: var(--gold); }
        .hero__subtitle {
          font-size: clamp(1.1rem,2.5vw,1.4rem); color: rgba(255,255,255,0.7);
          font-style: italic; margin-bottom: 20px; opacity: 0;
        }
        .hero__desc {
          font-size: 1rem; color: rgba(255,255,255,0.55); line-height: 1.7;
          max-width: 500px; margin-bottom: 40px; opacity: 0;
        }
        ...
        .stats__grid {
          ...
          gap: 1px; background: rgba(255,255,255,0.08); border-radius: 8px; overflow: hidden;
        }
        .stat-card {
          background: var(--navy-light); padding: 32px 24px; text-align: center; opacity: 0;
        ...
        .service-card {
          ...
          border: 1px solid var(--gray-light); transition: all 0.35s ease;
        ...
        .service-card__link {
          background: none; border: none; color: var(--gold-dark); font-size: 0.88rem;
          font-weight: 600; cursor: pointer; padding: 0; transition: color 0.2s;
        }
        ...
        .why-item__title { font-size: 1rem; color: var(--navy); margin-bottom: 4px; font-weight: 600; font-family: 'Inter',sans-serif; }
        ...
        .why-card-main {
          ...
          color: var(--white); width: 280px; box-shadow: 0 30px 80px rgba(10,22,40,0.3);
        ...
        .why-card-float {
          position: absolute; background: var(--white); border-radius: 10px; padding: 12px 18px;
          font-size: 0.82rem; font-weight: 600; color: var(--navy);
          box-shadow: 0 8px 30px rgba(0,0,0,0.12); border: 1px solid var(--gray-light);
        }
        ...
        .testimonial-card__avatar {
          width: 42px; height: 42px; background: linear-gradient(135deg,var(--navy),var(--navy-mid));
